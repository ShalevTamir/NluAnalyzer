...
from services.sensor_parsing.subject_detector import detect as detect_subject
from services.sensor_parsing.text_partitioner import extract_sentences
...
class TextParser:
    ...
    def parse(self, text: str):
        ...
        for sentence_tokens in extract_sentences(tokens):
            parameter_name = detect_subject(sentence_tokens)
